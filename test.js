...
const treatFile = async (file) => {
  try {
    ...
    return new Promise((resolve, reject) => {
        ...
        switch (line.split("\t")[0][0]) {
          case line.split("\t")[0][0] !== "#":
            ...
            switch (qualityScore) {
              ...
              case qualityScore.match(CASE00):
              ...
              case qualityScore.match(CASE01):
                await AnalyseGenetique.create({
                  Barcode: user._id,
                  ID: line.split("\t")[2],
                  POS: line.split("\t")[1],
              ...
              case qualityScore.match(CASE11):
                await AnalyseGenetique.create({
                  Barcode: user._id,
                  ID: line.split("\t")[2],
                  POS: line.split("\t")[1],
              ...
              case qualityScore.match(CASE12):
                await AnalyseGenetique.create({
                  Barcode: user._id,
                  ID: line.split("\t")[2],
                  POS: line.split("\t")[1],
          ...
          case line.split("\t")[0][0] === "#":
            console.log("ligne n'est pas traiter");
        }
      });
      ...
      rl.on("end", () => {
        console.log("VCF file successfully processed");
        resolve();
      });
